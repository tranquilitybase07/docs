...
The `CustomerPortal` component gives your users a complete billing management interface — subscriptions, invoices, payment methods, and settings.
...
See the full [CustomerPortal reference](/sdk/components/customer-portal) for all props and display modes.

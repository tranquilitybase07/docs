...
Feature gating lets you show, hide, or limit functionality based on a customer's subscription plan. For example:

- **Free plan**: 100 API calls/month, no custom branding
- **Pro plan**: 10,000 API calls/month, custom branding, priority support
- **Enterprise**: Unlimited API calls, white-label, dedicated support
...
Content is only rendered if the user has access. Add a fallback for denied users:

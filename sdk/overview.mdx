...
| **Hooks** | React Query-powered hooks for subscriptions, entitlements, usage |
...
| Component | Purpose |
|-----------|---------|
| [`<PricingTable />`](/sdk/components/pricing-table) | Display plans with pricing, features, and checkout |
